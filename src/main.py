...
def run_KITTI_visual_odometry(sequences_path : str, seq_name : str, seq_idx : int, gt : np.ndarray, camera_calib : np.ndarray, time_stamps : np.ndarray, preffered : int) -> None:
    """
    ...
    os.chdir("../.." + os.path.realpath(__file__).split("src")[0])